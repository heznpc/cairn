...
- **Output presets** — `standard` (default) balances detail and clarity, `compact` reduces label/road density for small placements, and `minimal` removes more labels so the map can sit inside a larger design.
